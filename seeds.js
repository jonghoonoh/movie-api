...
const reviews = [
  ...
  },
  {
    ...
    rating: 2,
    content:
      '음악과 잡동사니를 좋아하는 소년 ‘바트’. 그는 언제나 희망찬 미래를 꿈꾼다. “넌 한참 모자라, 꿈은 돈이 안돼” 하지만, 아버지의 폭력과 불행을 참지 못해 떠난 엄마. 지옥 같았던 유년 시절을 벗어나 밴드 머시미(Mercy Me)로 홀로 서보지만 어린 시절의 트라우마는 계속해서 그를 괴롭히는데…  “이제 용서하려 합니다” 더 이상 도망치지 않기 위해 용기 내 아버지를 마주하는 ‘바트’.  과연, 상처 받은 아이의 음악은 어떻게 세상을 울릴 수 있을까?',
  },
  {
    title: '와일드 시티',
    rating: 2,
    content:
      '무장강도죄로 9년 복역한 ‘리암’은 출소 후 새로운 삶을 살기로 결심한다. 하지만 불법 자금 세탁원으로 일하는 동생 ‘숀’과 오랜 소꿉친구 ‘바이포드’가 범상치 않은 일에 휘말리게 되고 경찰과 거대 조직의 추격 속, 가족을 지키기 위해 사건을 파헤치기 시작하는데…  절대 그 누구도 믿어서는 안된다!',
  },
  {
    title: '다만 악에서 구하소서',
    rating: 3,
  ...
  },
  {
    ...
    rating: 2,
    content:
      '알을 낳지 못해 놀림당하던 암탉 ‘뚜루’! 하지만 마음씨 착한 ‘이사벨’ 할머니는 그런 ‘뚜루’에게  노래하는 재능이 있다는 사실을 알고 음악을 알려준다.  농장에서 함께 행복한 시간을 보내던 ‘뚜루’와 ‘이사벨’ 할머니! 그러던 어느 날 할머니가 지붕에서 떨어지는 사고를 당해 기억을 잃어버리게 되고 ‘뚜루’마저 알아보지 못한다.  할머니의 기억을 찾기 위해 ‘뚜루’는 서커스단에서  노래를 부르기 시작하고 뛰어난 실력에 단숨에 슈퍼스타가 된다. 하지만 욕심쟁이 단장 ‘트래블리’는 ‘뚜루’를 차지하기 위해 음모를 꾸미는데…',
  },
  {
    title: '테넷',
    rating: 3,
  ...
  },
  {
    ...
    rating: 3,
    content:
      '1950년, 브라질 리우데자네이루, 구스망 집안의 두 딸, 에우리디스와 귀다는 보수적인 아버지 밑에서 자란다. 아버지 마누엘의 엄격함에 지친 언니 귀다는 잘생긴 항해사와 사랑에 빠져 몰래 그리스로 달아난다. 피아니스트가 꿈인 여동생 에우리디스는 언니를 그리워하며 기다린다. 한편, 임신한 채로 홀로 돌아온 귀다를 아버지는 매몰차게 쫓아내고, 에우리디스는 언니가 돌아온 사실도 모른 채, 귀다의 행방을 찾는데……  언젠가 다시 만날 거라는 희망을 놓지 못하는 자매 이야기',
  },
  {
    title: '강철비',
    rating: 3,
  ...
  },
  {
    ...
    rating: 2,
    content:
      '영조 10년, 사라진 아내 간난을 찾아 나선 소리꾼 학규와 그의 딸 청이. 학규를 중심으로 뭉친 새로운 광대패들과 함께 흥과 한이 담긴 조선팔도의 여정이 시작된다. 가족을 찾기 위한 학규의 울림있는 외침 "우리는 다시 만나야 한다!"',
  },
  {
    title: '좋아해줘',
    rating: 3,
  ...
  },
  {
    ...
    rating: 2,
    content:
      '1906년 10월 15일, 비바람이 몰아치는 혼돈의 땅 홍콩. 동맹회 13성의 대표와 만나 혁명을 위한 봉기를 계획하기 위해 영웅 ‘쑨원’이 도착한다. 하지만 그를 암살하려는 수백 명의 자객들이 잠입하고, 흩어져 살던 8인의 숨은 고수는 스스로 표적이 되어 영웅을 지키려 한다. 혁명을 도모하기 위한 1시간, 끝없이 등장하는 암살자들로부터 영웅을 구하려는 8인의 목숨 건 사투가 시작된다.',
  },
  {
    title: '국도극장',
    rating: 3,
